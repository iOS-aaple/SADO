...
var menu: [Data] = [
    ...
    Data(id: 4, img: "5", name: "Hashi", show: false, price: "120 SAR" , rate: "★★★☆☆" ,category: "Meat" ,
    ...
    Data(id: 6, img: "7", name: "Saudi Coffee \n with Dates", show: false, price: "30 SAR" , rate: "★★★★★" ,category: "Desserts" ,
         description: " The traditional Saudi coffee, presented with Dates stuffed with nuts"),
    Data(id: 7, img: "8", name: "Um Ali", show: false, price: "30 SAR" , rate: "★★★★★" ,category: "Desserts" ,
         description: "Baked Puff pastry, blended with nuts, raisins and milk , coverd with cream and sprinkled with cinnamon"),
    Data(id: 8, img: "9", name: "Qatayef", show: false, price: "30 SAR", rate: "★★★☆☆" ,category: "Desserts" ,
         description: "Sweet dumpling filled with cream or nuts."),
    Data(id: 9, img: "10", name: "Ma'amoul", show: false, price: "25 SAR", rate: "★★★☆☆" ,category: "Desserts" ,
         description: "Butter cookie, filled with Date or nuts"),
    Data(id: 10, img: "11", name: "Kunafah", show: false, price: "30 SAR", rate: "★★★★☆" ,category: "Desserts" ,
    ...
    Data(id: 12, img: "13", name: "Water", show: false, price: "1.5 SAR", rate: "" , category: "Drinks" ,
